...
const RequestCartModal = ({ open, onClose }) => {
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      ...
      } else if (backendError && status && status < 500) {
  ...
  return (
    <div className="request-cart-overlay" onClick={onClose}>
      <div className="request-cart-modal" onClick={(e) => e.stopPropagation()}>
        ...
        {submitted ? (
          <div className="request-cart-confirmation">
            <h3>Request Submitted!</h3>
            <p>
              Thank you! Your artwork request has been submitted. We&rsquo;ll review
              availability and follow up with details soon.
            </p>
